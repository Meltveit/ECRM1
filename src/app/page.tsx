...
import { ImageWithFallback } from '@/components/ui/image-with-fallback'; // Import the new component
          ...
          <div className="relative">
            <div className="bg-white rounded-lg shadow-xl p-4 border">
              ...
              <ImageWithFallback
                ...
                fallbackSrc="https://picsum.photos/600/400?random=1" // Use picsum as fallback
                alt="ECRM Dashboard Preview"
                className="rounded-md w-full h-auto" // Ensure responsiveness
                width={600} // Provide width and height for next/image
                height={400}
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
            <p>© {new Date().getFullYear()} ECRM. All rights reserved.</p>
            <div className="flex gap-4 mt-4 md:mt-0">
              ...
              <Link href="https://facebook.com" className="hover:text-white transition">Facebook</Link>
            </div>
          </div>
        </div>
      </footer>
